...
{
  RenderRequest(std::shared_ptr<SSprite> p_sprite, int p_x, int p_y, int p_frameIndex, RenderLocation p_renderLocation, bool p_bWorld, SDL_Color p_modulationColor = { 0xFF, 0xFF, 0xFF, 0x00 });
...
{
  TextRenderRequest(std::string p_text, int p_x, int p_y, int p_h, int p_renderPriority, RenderLocation p_renderLocation);
...
class SRenderer
{
  ...
  void submitRenderRequest(std::shared_ptr<SSprite> p_sprite, int x, int y, int frameIndex, RenderLocation renderLocation, bool bWorld = true, SDL_Color modulationColor = { 0xFF, 0xFF, 0xFF, 0x00 });
  void submitTextRenderRequest(std::string text, int x, int y, int h, int renderPriority, RenderLocation renderLocation);
